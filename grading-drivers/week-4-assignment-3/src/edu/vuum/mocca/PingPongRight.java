...
public class PingPongRight {
    ...
    public static void process(String startString, 
        ...
        PlayPingPongThread ping = new PlayPingPongThread("a", pingSema, pongSema, maxIterations);
        PlayPingPongThread pong = new PlayPingPongThread("b", pongSema, pingSema, maxIterations);
